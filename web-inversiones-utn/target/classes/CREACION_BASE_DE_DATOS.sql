...
drop DATABASE INVERSIONES_DESARROLLO;
drop  USER 'usr_inversiones'@'localhost';



CREATE DATABASE INVERSIONES_DESARROLLO;
...
CREATE TABLE INV_0009_Condicion_Taxativa(
	 ...
	 tipo_Condicion varchar(60) not null CHECK (tipo_Condicion='TaxativasConValor' OR tipo_Condicion='TaxativasConIndicador' ),
	 tipo_Indicador_Economico varchar(30) not null CHECK (tipo_Indicador_Economico='Cuenta' OR tipo_Indicador_Economico='Indicador'),
	 nombre_Indicador_Economico varchar(60) not null,
	 comparador varchar(20) not null CHECK (comparador='Mayor' OR comparador='Menor' OR comparador='Igual'  OR comparador='Menor_igual'  OR comparador='Mayor_igual'),
	 tipo_Indicador_Economico_Comparar varchar(60) not null CHECK (tipo_Indicador_Economico_Comparar='Cuenta' OR tipo_Indicador_Economico_Comparar='Indicador' OR tipo_Indicador_Economico_Comparar='Valor Fijo'),
